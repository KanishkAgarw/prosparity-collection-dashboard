  ...
  return (
    <TableHeader>
      <TableRow className="bg-gradient-to-r from-slate-50 to-blue-50 border-b-2 border-slate-200">
        ...
        <TableHead className="font-bold text-slate-800 text-center py-4 px-4 whitespace-nowrap">Collection Status</TableHead>
        ...
        <TableHead className="font-bold text-slate-800 text-center py-4 px-4 whitespace-nowrap">Collected Amount</TableHead>
